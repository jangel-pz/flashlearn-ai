...
-- actualiza times_correct / times_incorrect de forma atomica en
-- una sola instruccion, evitando condiciones de carrera

-- Se define SIN "security definer": un usuario
